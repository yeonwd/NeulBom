...
@WebServlet("/admin/account/findadpw.do")
public class FindAdPw extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		RequestDispatcher dispatcher = req
				.getRequestDispatcher("/WEB-INF/views/admin/account/findadpw.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		AdminDTO dto = dao.find_pw(id, name, ssn);
		...
		if (dto == null || !dto.getName().equals(name) || !dto.getSsn().equals(ssn)){
			...
			RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/admin/account/findadid.jsp");
			dispatcher.forward(req, resp);
