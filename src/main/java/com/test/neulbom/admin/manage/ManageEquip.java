...
public class ManageEquip extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<RegEqDTO> regList = dao.regList(map);
		...
		//이전 10페이지
				...
				if(n == 1) {
					...
					sb.append(String.format("<nav aria-label=\"Page navigation example \"><ul class=\"pagination justify-content-center\"><li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/admin/manage/manageEquip.do?page=%d\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>", n-1));						
				}
				...
				while (!(loop > blockSize || n > totalPage)) {
					...
					if (n == nowPage) {
						...
						sb.append(String.format(" <li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/admin/manage/manageEquip.do?page=%d\">%d</a></li> ", n, n));			
					}
				...
				if(n > totalPage) {
					...
					sb.append(String.format("<li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/admin/manage/manageEquip.do?page=%d\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li></ul></nav>", n));			
				}
