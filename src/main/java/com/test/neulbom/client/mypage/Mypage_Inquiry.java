		...
		//페이징
				...
				for (int i = 1; i <= totalPage; i++) {
					if (i == nowPage) {
						...
						sb.append(String.format(" <a href=\"/neulbom/client/mypage/mypage_inquiry.do?page=%d\">%d</a> ", i, i));
					}
				}
				...
				if(!(searchType == null && keyword == null)) {
			         if(n == 1) {
			            ...
			            sb.append(String.format("<nav aria-label=\"Page navigation example \"><ul class=\"pagination justify-content-center\"><li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_inquiry.do?searchType=%s&keyword=%s?page=%d\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>", searchType, keyword, n-1));                  
			         }
			         ...
			         while (!(loop > blockSize || n > totalPage)) {
			            ...
			            if (n == nowPage) {
			               ...
			               sb.append(String.format(" <li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_inquiry.do?searchType=%s&keyword=%s&page=%d\">%d</a></li> ", searchType, keyword, n, n));         
			            }
			         ...
			         if(n > totalPage) {
			            ...
			            sb.append(String.format("<li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_inquiry.do?searchType=%s&keyword=%s&page=%d\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li></ul></nav>", searchType, keyword, n));         
			         }
			      } else {
			         ...
			         if(n == 1) {
			            ...
			            sb.append(String.format("<nav aria-label=\"Page navigation example \"><ul class=\"pagination justify-content-center\"><li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_inquiry.do?page=%d\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>", n-1));                  
			         }
			         ...
			         while (!(loop > blockSize || n > totalPage)) {
			            ...
			            if (n == nowPage) {
			               ...
			               sb.append(String.format(" <li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_inquiry.do?page=%d\">%d</a></li> ", n, n));         
			            }
			         ...
			         if(n > totalPage) {
			            ...
			            sb.append(String.format("<li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_inquiry.do?page=%d\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li></ul></nav>", n));         
			         }
			      }
						//넘겨야 되는 것들
