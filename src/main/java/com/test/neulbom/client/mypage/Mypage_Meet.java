...
import com.test.neulbom.client.repository.MeetDTO;
import com.test.neulbom.client.repository.ProtectDTO;

@WebServlet("/client/mypage/mypage_meet.do")
public class Mypage_Meet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (protect_seq == null) {
			protect_seq = (String) session.getAttribute("resi_seq");
		}
		...
		map.put("begin", begin + "");
		map.put("end", end + "");
		map.put("protect_seq", protect_seq);

		map.put("start_date", start_date); 
		map.put("end_date", end_date);
		map.put("search", search);

		List<MeetDTO> list = dao.list(map);
		...
		if(search.equals("y")) {
	         if(n == 1) {
	            ...
	            sb.append(String.format("<nav aria-label=\"Page navigation example \"><ul class=\"pagination justify-content-center\"><li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_meet.do?start_date=%s&end_date=%s&page=%d\" aria-label=\"Previous\"><span aria-hidden=\"true\">&laquo;</span></a></li>", start_date, end_date, n-1));                  
	         }
	         ...
	         while (!(loop > blockSize || n > totalPage)) {
	            ...
	            if (n == nowPage) {
	               ...
	               sb.append(String.format(" <li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_meet.do?start_date=%s&end_date=%s&page=%d\">%d</a></li> ", start_date, end_date, n, n));         
	            }
	         ...
	         if(n > totalPage) {
	            ...
	            sb.append(String.format("<li class=\"page-item\"><a class=\"page-link\" href=\"/neulbom/client/mypage/mypage_meet.do?start_date=%s&end_date=%s&page=%d\" aria-label=\"Next\"><span aria-hidden=\"true\">&raquo;</span></a></li></ul></nav>", start_date, end_date, n));         
	         }
	      } else {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/client/mypage/mypage_meet.jsp");
