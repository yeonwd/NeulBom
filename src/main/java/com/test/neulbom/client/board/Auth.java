 ...
 * 
 * import com.test.toy.board.repository.BoardDAO; import
 * com.test.toy.board.repository.BoardDTO;
 * 
 * public class Auth {
 * 
 ...
 * 
 * //글쓴이 본인? or 관리자? QnaDAO dao = new QnaDAO();
 * 
 ...
 * write("<script>alert('failed'); location.href='/toy/index.do';</script>");
 * writer.close();
 * 
 * return true;
 * 
