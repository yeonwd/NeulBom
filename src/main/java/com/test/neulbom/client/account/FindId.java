...
@WebServlet("/client/account/findid.do")
public class FindId extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/client/account/findid.jsp");
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String ssn = req.getParameter("mem_ssn");
		
		//dto에 해당 정보를 받아서 DAO로 보내 DB로 찾음
		//해당 정보가 있으면 dto값이, 없으면 null값이 들어온다
		ClientDAO dao = new ClientDAO();
		AccountDTO dto = dao.find_id(name, ssn);
