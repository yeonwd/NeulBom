...
<form action="/neulbom/client/register/register.do" method="post" onsubmit="showAlert()">    

        <table class="regi_info" id="regi_prot_info">
        <tr><div id="title"><h1>보호자 회원가입</h1></div></tr>
        <tr><div id="necessary"><span class="star">*</span>는 필수 입력항목 입니다.</div></tr>
        
       <tr>
            <th>보호자 이름<span class="star">*</span></th>
            <td><input type="text" name="pname" onkeyup="checkReg(event)" maxlength="8" required/></td>
            
       </tr>
       <tr>
            <th>보호자 ID<span class="star">*</span></th>
            <td><input type="text" id="userId" required name="pid" maxlength="12"><input type="button" class="btn" id="btn_again" value="중복확인" onclick="validateId()"><br>
            <div class="notice" id="idNotice">아이디: 영문, 숫자 최소 1개 포함 4~12자 이내</div>
       </tr>
       <tr>
            <th>비밀번호<span class="star">*</span></th>
            <td><input type="password" name="ppw" class="notice" id="passwordField" required maxlength="20" onkeyup="checkPasswordValidity()"><br>비밀번호: 영문, 숫자, 특수문자 최소 1개 포함 6자~20자 이내<br><span id="passwordValidityText"></span></td>
            
       </tr>
       <tr>
        <th>비밀번호 확인<span class="star">*</span></th>
        <td><input id="passwordFieldCheck" type="password" maxlength="20" required onkeyup="checkPasswordMatch()"><br><span style="color:tomato;" id="passwordSame"></span></td>
   </tr>
<tr>
  <th>보호자 주민번호<span class="star">*</span></th>
  <td>
        <input id="birth" pattern="\d{6}" placeholder="" required th:field="*{birth}" type="text" name="pssn1" oninput="convertDateFormat(event)" style="width:100px !important;">
    <span id="ssnSeparator">-</span>
    <input type="password" name="pssn2" class="ssn2" style="width:130px;" required maxlength="7" onkeypress="return isNumeric(event)">
  </td>
</tr>
    <th>보호자 전화번호<span class="star">*</span></th>
<!-- 숫자만 입력되도록함 -->    
<td>
  <input type="text" id="telFirst" class="tel" value="010" name="ptel1" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required maxlength="3">
  - <input type="text" name="ptel2" id="telSecond" class="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required maxlength="4">
  - <input type="text" name="ptel3" id="telThird" class="tel" oninput="this.value = this.value.replace(/[^0-9]/g, '');" required maxlength="4">
</td>

</tr>
    <tr>
            <th>보호자 주소<span class="star">*</span></th>
            <td><input type="text" name="padr" id="sample4_postcode" required readonly><input type="button" class="btn" value="우편번호 검색"  onclick="sample4_execDaumPostcode()" ><br>
                   <input type="text" id="sample4_roadAddress" name="proad" class="address" readonly> 도로명 주소<br>
                    <input type="text" name="padrdetail" class="address" required> 상세 주소<br>  
            </td>
       </tr>
       <tr>
            <th>보호자 이메일</th>
            <td><input type="text" name="pemail1" required> <div style="display:inline">@</div> <input type="text" name="pemail2" required></td>
       </tr>
       
       <tr>
        <th>입주자 아이디<span class="star">*</span></th>
        <td>
  <input type="text" name="rid" required id="resiCheck">
  <input type="button" class="btn" id="btn_again" value="입주자확인" onclick="validateResi()">
   ...
   <tr>
        <th>입주자와의 관계<span class="star">*</span></th>
        <td>
            나는 입주자의 : 
            <select name="rela" required>
                <option>부</option>
                <option>모</option>
                <option>자녀</option>
                <option>손자</option>
    ...
    <!-- 개인정보 -->
    <div id="blue_box"> 회원가입약관 및 개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.</div>

    <div class="term_box">
        <div class="term_content">
                <div id="regi_header">회원가입 약관</div>
                <div class="regi_term">제1조(목적) 이 약관은 늘봄 실버타운(전자상거래 사업자)이 운영하는 늘봄 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.

                        ※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
                      
                      제2조(정의)
                      
                        ① “몰”이란 늘봄 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
                      ...
                      제3조 (약관 등의 명시와 설명 및 개정) 
                        ...
                        ① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호․모사전송번호․전자우편주소, 사업자등록번호, 통신판매업 신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 늘봄 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
                ...
                <div id="regi_second">개인정보처리방침안내</div>
                <div class="regi_term">제1조 총칙
                    ...
                    부  칙 시행일 등
                    본 방침은 2022년 01월 01일부터 시행합니다.
                </div>
        </div>        
    </div>

    <div class="checkbox">
    <input type="checkbox" id="regi_checkbox" required> 회원가입약관 및 개인정보처리방침안내의 내용에 동의합니다.
    </div>
    </div>
   
    <div>
    <input type="submit" value="회원가입" class="btn" id="register" >
...
function validateResi() {
    const resiCheck = document.getElementById('resiCheck');
    const resiId = resiCheck.value;

    // GET 방식으로 자바로 전송
    const childWindow = window.open("resicheck.do?resiId=" + encodeURIComponent(resiId), '_blank', "width=500,height=300,left=1000,top=200");

    childWindow.addEventListener("load", function() {
        childWindow.document.getElementById("confirmButton").addEventListener("click", function() {
            resiCheck.readOnly = true;
            childWindow.close();
        /*     
            // 추가 버튼 보이기
...
/* 
function validateResi2() {
	 const resiCheck = document.getElementById('resiCheck');
	  const resiCheck2 = document.getElementById('resiCheck2');
	  const resiId = resiCheck.value;
	  const resiId2 = resiCheck2.value;
    
    if (resiId === resiId2) {
        alert("중복된 입주자 아이디입니다.");
        resiCheck2.value = ""; // resiCheck2 값 초기화
      } else {
        // GET 방식으로 자바로 전송
        const childWindow = window.open("resicheck2.do?resiId2=" + encodeURIComponent(resiId2), '_blank', "width=500,height=300,left=1000,top=200");

        childWindow.addEventListener("load", function() {
          childWindow.document.getElementById("confirmButton").addEventListener("click", function() {
            resiCheck2.readOnly = true;
            childWindow.close();
            document.getElementById('btn_del').disabled = true; // 제거 버튼 비활성화
          });
        });
      }
}
...
/* 버튼 추가 제거 */
function showTempElements() {
    var tempDiv = document.querySelector(".temp");
    const resiCheck2 = document.getElementById('resiCheck2');
    
    tempDiv.style.display = "block";
    resiCheck2.required = true;
    resiCheck2.disabled = false;
  }
...
function hideTempElements() {
    ...
    resiCheck2.required = false;
    resiCheck2.disabled = true;
  }
</script>
<script>
