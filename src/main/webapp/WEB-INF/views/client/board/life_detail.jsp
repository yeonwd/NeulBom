...
<body>
	...
	<%@ include file="/WEB-INF/views/inc/headerclient.jsp" %>
	 <div class="introducetitle">생활</div>
        ...
        <span class="sidebar">
            <div class="bg-light border-right">
                <div class="list-group list-group-flush">
                    ...
                    <a href="/neulbom/client/board/life.do" class="list-group-item list-group-item-action" style="background-color: #e9ecef;">생활</a>
                </div>
            </div>
        </span>
            ...
            <table class="table table-bordered table-hover content-head_wj">
                <thead>
                    <tr>
                      ...
                      <th>${fn:substring(dto.life_date.toString(), 0, 10)}</th>
                      <th>${dto.read}</th>
                    </tr>
                </thead>
            </table>
